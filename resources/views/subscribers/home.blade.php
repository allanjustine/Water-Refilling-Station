                    ...
                    <div class="panel-heading">
                        ...
                        <u><b>{{ auth()->user()->created_at->diffForHumans() }} - BILLINGS
                                ...
                                <span class="text-danger">
                                    ...
                                    @if ($daysUntilExpiration1Month <= 7) <p>Dear Subscribers! Your {{ $user->subscription_type }} subscription
                                        ...
                                        @if ($daysUntilExpiration1Year <= 7) <p>Dear Subscribers! Your {{ $user->subscription_type }} subscription
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $report->user->address }}, {{ $report->user->municipality }}</td>
                                <td><strong>₱{{ number_format(($report->order_quantity + $report->own) * $report->product->price + ($report->product->extra * $report->buy), 2) }}</strong></td>
                        ...
                        <tfoot>
                            <th colspan="3">
                                <p class="text-right">Total Sales:</p>
                            </th>
                            <th colspan="2">
                                <p><strong>
                                        ₱{{ number_format(
                                        $dailyReports->sum(function($order) {
                                            return ($order->order_quantity + $order->own) * $order->product->price + ($order->product->extra * $order->buy);
                                        }), 2
                                        ) }}
                                    </strong></p>
                            </th>
