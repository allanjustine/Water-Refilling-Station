                ...
                <div class="card-body">
                    <form action="{{ route('update.settings', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row gy-3 overflow-hidden">
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="btn text-white bg-primary">
                                    ...
                                    <input id="avatar" type="file" class="form-control d-none pr-4 @error('avatar') is-invalid @enderror" name="avatar" value="{{ old('avatar') }}" accept="image/*" autocomplete="avatar" autofocus onchange="previewImage(event)">
                                </div>
                                @error('avatar')
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select name="municipality" id="municipality" class="form-select @error('municipality') is-invalid @enderror">
                                ...
                                <optgroup label="MUNICIPALITY">
                                    <option value="Abuyog" {{ auth()->user()->municipality == 'Abuyog' ? 'selected' : '' }}>Abuyog</option>
                                    <option value="Javier" {{ auth()->user()->municipality == 'Javier' ? 'selected' : '' }}>Javier</option>
                                    <option value="Macarthur" {{ auth()->user()->municipality == 'Macarthur' ? 'selected' : '' }}>Macarthur</option>
                                    <option value="Mahaplag" {{ auth()->user()->municipality == 'Mahaplag' ? 'selected' : '' }}>Mahaplag</option>
                                </optgroup>
                            </select>
                            @error('municipality')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="station" name="station" value="{{ auth()->user()->station }}">
                        </div>
                        @else
                        <input type="text" class="form-control" id="station" name="station" value="{{ auth()->user()->station ? auth()->user()->station : null }}" hidden>
                        @endif
