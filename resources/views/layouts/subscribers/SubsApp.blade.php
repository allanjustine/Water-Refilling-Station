                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <!---- PROFILE ---
                                            <a class="dropdown-item" href="{{ route('subscribers.profile') }}"
                                               ">
                                                <b>{{ __('My Profile') }}</b>
                                            </a>---->
