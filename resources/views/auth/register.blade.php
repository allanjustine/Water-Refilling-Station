                        ...
                        {{-- <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="subscription_type" id="subscription_type" class="form-select">
                                    <option hidden selected>Select Subscription Duration</option>
                                    <option disabled>Select Subscription Duration</option>
                                    <option value="1_month">1 Month Subscription</option>
                                    <option value="1_year">1 Year Subscription</option>
                                </select>
                            </div>
                        </div> --}}
