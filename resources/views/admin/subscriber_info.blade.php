        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-hovered">
                    ...
                    <tbody>
                        @foreach ($subscriberInvoices as $invoice)
                        <tr>
                            ...
                            <td><a href="#" data-bs-toggle="modal" data-bs-target="#invoice{{ $invoice->id }}" class="btn btn-primary">Update</a></td>
                        </tr>
                            ...
                            <div class="modal-dialog">
                                <form action="{{ route('invoice.update', $invoice->id) }}" method="POST">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <input type="text" name="billings" hidden value="{{ $invoice->user->billings }}">
                                        <div class="form-group mb-3">
            ...
            @empty
            <tr>
                <td colspan="8" class="text-center">No invoice data yet.</td>
            </tr>
            @endforelse
            </tbody>
            </table>
